            ...
            <div class="row mb-4 wow fadeIn">
                ...
                <div class="col">
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            <tr>
                                <td><a href="addplayer.php"><i class="fas fa-plus-circle"></i> Add Players</a></td>
                                <td><i class="fas fa-minus-circle"></i> Delete Players</td>
                            </tr>
                        </tbody>
                    </table>
                    <hr>
                    ...
                    <table class="table table-hover table-sm">
                        <tbody>
                            <tr>
                                <td><i class="fas fa-plus-circle"></i> Add Matches</td>
                                <td><i class="fas fa-minus-circle"></i> Delete Matches</td>
                            </tr>
                        </tbody>
                    </table>
                    <hr>
                    ...
                    <table class="table table-hover table-sm">
                        <tbody>
                            <tr>
                                <td><i class="fas fa-plus-circle"></i> Add Tournaments</td>
                                <td><i class="fas fa-minus-circle"></i> Delete Tournaments</td>
                            </tr>
                        </tbody>
                    </table>
                    <!-- ADMINISTRATION LIST -->
